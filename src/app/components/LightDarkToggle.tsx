...
const LightDarkToggle = () => {
   ...
   return (
      <div>
         <div className="mix-blend-difference z-[100] flex fixed bottom-[20px] right-[20px] md:bottom-[40px] md:right-[40px] items-center">
               <div className="flex mx-[5px]">
                  <input onClick={btn_toggle} defaultChecked={inputState} type="checkbox" className="checkbox hidden" id="checkbox" />
                  <label htmlFor="checkbox" className="checkbox-label">
                     <svg width="14" className="light fill-[#ffb400]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
