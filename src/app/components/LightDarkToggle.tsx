         ...
         <div className="skin flex">
               ...
               <div className="flex mx-[5px]">
                  ...
                  <label htmlFor="checkbox" className="checkbox-label">
                     <svg width="14" className="light fill-[#fff]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                     ...
                     <span style={{transform: `translateX(${dark})`}} className="ball"></span>
                  </label>
               </div>
               <span>Dark</span>
         </div>
