...
const Header = () => {
  ...
  return (
    <div className="pointer-events-none relative z-[5]">
        <div onClick={menu_toggle} className='menu_toggle pointer-events-auto'>
        ...
        <div className="px-[20px] pt-[20px] flex justify-end md:justify-between items-center md:items-start">
            <div className="menu_items pointer-events-auto h-[100%] z-[1000] fixed md:static left-[0] top-[0] w-[80vw] md:w-[initial] translate-x-[-80vw] md:translate-x-[0]">
                ...
                <a className="block md:text-center px-[20px] md:px-[50px] py-[8px] text-[3vw] md:text-[1.1vw] font-[600] mb-[10px]" href="/skills">
                    Skills
                </a>
                <a className="block md:text-center px-[20px] md:px-[50px] py-[8px] text-[3vw] md:text-[1.1vw] font-[600] mb-[10px]" href="/services">
                    Services
                </a>
            ...
            <div className="pointer-events-auto bio_link">
                ...
                <div className="flex mt-[5px] linked_items pointer-events-auto">
                    <a href="https://github.com/seanoneilrosario" className="mr-[8px]">
                    ...
                    <a href="https://www.linkedin.com/in/sean-rosario-67147b18a" className="">
